...
class MocapDM(object):
    ...
    def calc_rot_vel(self, seg_0, seg_1, dura):
        ...
        # euler_target = euler_from_quaternion(seg_0[3],seg_0[0],seg_0[1],seg_0[2])
        # euler_curr = euler_from_quaternion(seg_1[3],seg_1[0],seg_1[1],seg_1[2])
        # return (euler_target-euler_curr)/dura
